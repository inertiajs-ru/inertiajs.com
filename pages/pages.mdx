...
Кроме того, если для Вашего приложения критически важно установить заголовок страницы и метатеги на стороне сервера, Вы можете использовать [данные корневого шаблона](/responses#данные-корневого-шаблона) для этого.
