...
function MDXContent(_ref) {
  ...
  return Object(_mdx_js_react__WEBPACK_IMPORTED_MODULE_4__["mdx"])(MDXLayout, Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, layoutProps, props, {
    ...
    examples: [{
      ...
      description: 'Посредник HandleInertiaRequests обеспечивает разумное значение по умолчанию для приложений Laravel, which uses either a hash of the "app.asset_url" config value or the mix-manifest.json file.'
    }, {
      name: 'Rails',
      language: 'ruby',
